...
MYOPS  = test_concat test_subscript test_len_cap test_input test_find_char test_find_string test_substring test_split
MYM2   = test_ctor_copy test_swap_assign test_ctor_int test_ctor_charArray_in
